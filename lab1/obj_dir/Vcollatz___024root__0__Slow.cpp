...
VL_ATTR_COLD void Vcollatz___024root___eval_static__TOP(Vcollatz___024root* vlSelf);
...
VL_ATTR_COLD void Vcollatz___024root___eval_static(Vcollatz___024root* vlSelf) {
    ...
    // Body
    Vcollatz___024root___eval_static__TOP(vlSelf);
    vlSelfRef.__Vtrigprevexpr___TOP__clk__0 = vlSelfRef.clk;
}

VL_ATTR_COLD void Vcollatz___024root___eval_static__TOP(Vcollatz___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcollatz___024root___eval_static__TOP\n"); );
    Vcollatz__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.collatz__DOT__temp = 0U;
}
...
VL_ATTR_COLD void Vcollatz___024root___stl_sequent__TOP__0(Vcollatz___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.collatz__DOT__temp = ((1U == (1U & vlSelfRef.dout))
                                     ? ((IData)(1U) 
                                        + ((IData)(3U) 
                                           * vlSelfRef.dout))
...
VL_ATTR_COLD void Vcollatz___024root___ctor_var_reset(Vcollatz___024root* vlSelf) {
    ...
    vlSelf->collatz__DOT__temp = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 16274122727159822644ull);
