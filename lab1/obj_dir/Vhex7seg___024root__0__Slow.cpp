...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vhex7seg___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag);
#endif  // VL_DEBUG
...
#ifdef VL_DEBUG
            Vhex7seg___024root___dump_triggers__stl(vlSelfRef.__VstlTriggered, "stl"s);
#endif
            VL_FATAL_MT("hex7seg.sv", 1, "", "Settle region did not converge after 100 tries");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
    } while (Vhex7seg___024root___eval_phase__stl(vlSelf));
}
...
VL_ATTR_COLD bool Vhex7seg___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in);

#ifdef VL_DEBUG
VL_ATTR_COLD void Vhex7seg___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhex7seg___024root___dump_triggers__stl\n"); );
    // Body
    if ((1U & (~ (IData)(Vhex7seg___024root___trigger_anySet__stl(triggers))))) {
...
VL_ATTR_COLD bool Vhex7seg___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhex7seg___024root___trigger_anySet__stl\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
VL_ATTR_COLD bool Vhex7seg___024root___eval_phase__stl(Vhex7seg___024root* vlSelf) {
    ...
    __VstlExecute = Vhex7seg___024root___trigger_anySet__stl(vlSelfRef.__VstlTriggered);
    if (__VstlExecute) {
...
VL_ATTR_COLD void Vhex7seg___024root___dump_triggers__ico(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    ...
    // Body
    if ((1U & (~ (IData)(Vhex7seg___024root___trigger_anySet__ico(triggers))))) {
        VL_DBG_MSGS("         No '" + tag + "' region triggers active\n");
    }
    if ((1U & (IData)(triggers[0U]))) {
...
VL_ATTR_COLD void Vhex7seg___024root___ctor_var_reset(Vhex7seg___024root* vlSelf) {
    ...
    vlSelf->y = VL_SCOPED_RAND_RESET_I(7, __VscopeHash, 11123243248953317070ull);
